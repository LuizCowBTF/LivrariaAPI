...
### Baseado em curso de formação para atualização profissional chamado “NNode.JS: melhorando o fluxo de desenvolvimento e integração de sua equipe”, disponibilizado pela Alura e ministrado pela instrutora Juliana Amoasei. Nesta oportunidade pude atualizar meus conhecimentos em:

* Entender como instalar um projeto com ambientes e configurações específicas
* Praticar como adicionar features a um produto e testá-las
* Aprender conceitos importantes de Integração Contínua e como utilizá-los
* Utilizas ferramentas do GitHub para versionar e incorporar código a uma base
